                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-menu footer-menu-1">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Animated Vedios</a></li>
            ...
            <div class="footer-support">
                <div class="footer-call">
                    ...
                    <span class="font-size-1-20">
                        Contact us at <a href="#">artbots02@gmail.com
                        </a>
                    </span>
                </div>
                <div class="footer-messege">
                    ...
                    <p class="font-size-1-18">PERFECT SOLUTION From <span>artbots <br>
                            +91 8979020271</span></p>
                </div>
            </div>
            <div class="footer-copyright">
                <div class="footer-copyright-item-1">
                    <p class="font-size-1-18">Copyright © 2024 - Powered by <a href="index-2.html">artbots</a></p>
                </div>
                <div class="footer-copyright-social-icon">
                    <ul>
                        ...
                        <li><a href=" https://www.instagram.com/art_bots"><i class="fa-brands fa-instagram"></i></a></li>
                    </ul>
                </div>
