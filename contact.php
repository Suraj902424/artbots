...
<!-- Mirrored from devsaidul.com/ui/dynamic/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Feb 2025 08:35:59 GMT -->
<head>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="contact-info-wrapper vre-slide-up-gsap">
                        <div class="contact-info-inner">
                            ...
                            <div class="contact-text">
                                ...
                                <h5 class="font-size-1-26">+91 8979020271</h5>
                            </div>
                        </div>
                        <div class="contact-info-inner">
                            <div class="contact-icon">
                            ...
                            <div class="contact-text">
                                ...
                                <h5 class="font-size-1-26">artbots02@gmail.com</h5>
                            </div>
                        </div>
                        <div class="contact-info-inner">
                            <div class="contact-icon">
                            ...
                            <div class="contact-text">
                                <p class="font-size-1-16">51a Agra</p>
                                <h5 class="font-size-1-26">CB4 3AA, India</h5>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 offset-lg-1 offset-xl-1">
                    <div class="form-wrapper">
                        ...
                        <form id="contactForm"  class="vre-slide-down-gsap" action="submit.php" method="POST">
...
<div class="popup" id="popup">
    ...
    <div class="map-area">
        <div class="map">
            <iframe             src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d449220.87980402904!2d77.8529309!3d27.2188896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397477af870b2a3f%3A0x1f8d9073e78c5d14!2sSikandra%2C%20Agra%2C%20Uttar%20Pradesh%2C%20India!5e0!3m2!1sen!2sus!4v1615477076035!5m2!1sen!2sus"                 width="1920" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
    <!-- End Map Area -->
...
<script>
        document.getElementById("contactForm").addEventListener("submit", function(event) {
            ...
            // AJAX to submit the form data without reloading the page
...
<!-- this is contact form valid number js -->
<script>
    document.getElementById("contactForm").addEventListener("submit", function (event) {
