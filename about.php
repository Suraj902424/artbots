...
<!-- Mirrored from devsaidul.com/ui/dynamic/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Feb 2025 08:35:50 GMT -->
<head>
...
<?php include 'include/header.php'?>
    ...
    <section class="bread-crumb-area">
        <div class="container">
            <div class="bread-crumb-wrapper">
                ...
                <a href="#" class="current-page">About Company</a>
            </div>
                        <div class="bread-crumb-title">
                <h2 class="split-collab">About Company</h2>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-5">
                    <div class="about-img vre-reveal-one">
                        <img src="assets/images/bots/digital.about.webp" alt="VRE" class="vre-reveal-image-one">
                    </div>
                </div>
                    ...
                    <div class="about-info">
                        ...
                        <div class="about-item">
                            <div class="about-item-inner about-item-inner-1">
                                ...
                                <p>We are a dynamic and forward-thinking <br> startup dedicated to revolution</p>
                            </div>
                            <div class="about-item-inner about-item-inner-2">
                                ...
                                <h6 class="font-size-1-20">Digital Advertising</h6>
    ...
    <?php include 'include/digital_marketing_home.php' ?>
...
<!-- Mirrored from devsaidul.com/ui/dynamic/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Feb 2025 08:35:53 GMT -->
</html>